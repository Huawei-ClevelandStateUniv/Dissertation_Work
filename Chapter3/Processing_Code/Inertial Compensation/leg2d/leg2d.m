...
%	- x and y coordinates of the same marker must be either both valid or both NaN (missing)
	...
	segments = [	1		2		NaN		NaN			NaN			NaN		NaN;	% HAT (head-arms-trunk)
					2		3		2		0.100*2		0.433		0.323	+1;		% thigh
					3		4		3		0.0465*2		0.433		0.302	-1;		% shank
					5		6		4		0.0145*2		0.500		0.475	-1];	% foot (note we use heel-toe line as segment axis!)
