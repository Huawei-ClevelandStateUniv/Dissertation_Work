...
for subj in range(3, 9):
    for trial in range(1, 3):
        ...
        num_par = 2 + num_states*4*2 
        
        store_path = 'LinCombDelay/Analysis_Paper/Subj0'+str(subj)+'Pert'+str(trial)+'_GFL_LinComb_delay60/'
        if not os.path.exists(store_path):
            os.makedirs(store_path)
            
        data_path = 'LinCombDelay/Results/Subj0'+str(subj)+'/Pert'+str(trial)+'_GFL_LinComb_delay60/'
