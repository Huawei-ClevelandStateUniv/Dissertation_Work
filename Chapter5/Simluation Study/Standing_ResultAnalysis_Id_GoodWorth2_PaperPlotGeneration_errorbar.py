...
labels = ['10 s', '30 s', '50 s', '70 s', '90 s']

ind_all = np.arange(len(labels)) + 1
...
ax1.errorbar(ind_id, mean_con_all[:, 2+2], yerr=std_con_all[:, 2+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax1.plot([1, len(ind_id)], [Con_GoodWorth[2], Con_GoodWorth[2]] , 'r--')
ax1.set_xticks(ind_all)
ax1.set_xticklabels(labels)

ax2.errorbar(ind_id, mean_con_all[:, 4+2], yerr=std_con_all[:, 4+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax2.plot([1, len(ind_id)], [Con_GoodWorth[4], Con_GoodWorth[4]] , 'r--')
ax2.set_xticks([])

ax3.errorbar(ind_id, mean_con_all[:, 3+2], yerr=std_con_all[:, 3+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax3.plot([1, len(ind_id)], [Con_GoodWorth[3], Con_GoodWorth[3]] , 'r--')
ax3.set_xticks([])

ax4.errorbar(ind_id, mean_con_all[:, 5+2], yerr=std_con_all[:, 5+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax4.plot([1, len(ind_id)], [Con_GoodWorth[5], Con_GoodWorth[5]] , 'r--')
ax4.set_xticks([])

ax5.errorbar(ind_id, mean_con_all[:, 0+2], yerr=std_con_all[:, 0+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax5.plot([1, len(ind_id)], [Con_GoodWorth[0], Con_GoodWorth[0]] , 'r--')
ax5.set_xticks([])

ax6.errorbar(ind_id, mean_con_all[:, 10+2], yerr=std_con_all[:, 10+2], marker='o', color = 'black',
       alpha=0.8,
       ecolor='black',
       capsize=4)
ax6.plot([1, len(ind_id)], [Con_GoodWorth[10], Con_GoodWorth[10]] , 'r--')
ax6.set_xticks([])
...
ax7.bar(ind_id, mean_con_all[:, 7+2], width, yerr=std_con_all[:, 7+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax7.bar(ind_g, Con_GoodWorth[7], width, alpha=0.8)
...
ax8.bar(ind_id, mean_con_all[:, 9+2], width, yerr=std_con_all[:, 9+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax8.bar(ind_g, Con_GoodWorth[9], width, alpha=0.8)
ax8.set_xticks([])
...
ax9.bar(ind_id, mean_con_all[:, 6+2], width, yerr=std_con_all[:, 6+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax9.bar(ind_g, Con_GoodWorth[6], width, alpha=0.8)
ax9.set_xticks([])
...
ax10.bar(ind_id, mean_con_all[:, 8+2], width, yerr=std_con_all[:, 8+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax10.bar(ind_g, Con_GoodWorth[8], width, alpha=0.8)
ax10.set_xticks([])
...
ax11.bar(ind_id, mean_con_all[:, 1+2], width, yerr=std_con_all[:, 1+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax11.bar(ind_g, Con_GoodWorth[1], width, alpha=0.8)
ax11.set_xticks([])
...
ax12.bar(ind_id, mean_con_all[:, 11+2], width, yerr=std_con_all[:, 11+2], align='center',
       ...
       ecolor='black',
       capsize=4)
ax12.bar(ind_g, Con_GoodWorth[11], width, alpha=0.8)
ax12.set_xticks([])

fig5 = plt.figure(figsize=(9, 2))
...
ax13.bar(ind_id, mean_con_all[:, 0], width, yerr=std_con_all[:, 0], align='center',
       ...
       ecolor='black',
       capsize=4)
ax13.bar(ind_g, Con_GoodWorth[0] + Con_GoodWorth[2], width, alpha=0.8)
...
ax14.bar(ind_id, mean_con_all[:, 1], width, yerr=std_con_all[:, 1], align='center',
       ...
       ecolor='black',
       capsize=4)
ax14.bar(ind_g, Con_GoodWorth[1] + Con_GoodWorth[6], width, alpha=0.8)
ax14.set_xticks([])
