...
normal_trial = 3;
motion_normal = importdata(strcat('../Participant_01/Cortex/passive_walking/motion_right_trial0'...
                            , num2str(normal_trial), '.txt'))*180/pi;
index_normal = importdata(strcat('../Participant_01/Cortex/passive_walking/motion_hs_to_index_right_trial0'...
...
motion_passive = load(strcat('../Participant_01/Indego/passive_walking/indego_trial_0'...
                        , num2str(passive_trial), '.mat'));                  
index_passive = importdata(strcat('../Participant_01/Indego/passive_walking/left_to_right_phase_index'...
