...
%     hold on;
    [~, h1] = errorfill(phase_normal', swing_EMG_mean_step(:, k, cons_trials(1))',...
                             swing_EMG_std_step(:, k, cons_trials(1))', 'b-', 1.0);
    hold on;
    [~, h2] = errorfill(phase_normal', swing_EMG_mean_step(:, k, cons_trials(2))',...
                             swing_EMG_std_step(:, k, cons_trials(2))', 'r-', 0.6);
    hold on;
...
legend([h1, h2], 'Passive Indego', 'Controlled Indego')
...
%     hold on;
    [~, h1] = errorfill(phase_normal', swing_EMG_mean_step(:, k, pert_trials(2))',...
                             swing_EMG_std_step(:, k, pert_trials(2))', 'b-', 1.0);
    hold on;
    [~, h2] = errorfill(phase_normal', swing_EMG_mean_step(:, k, pert_trials(1))',...
                             swing_EMG_std_step(:, k, pert_trials(1))', 'r-', 0.6);
    hold on;
...
% 'Normal Walking std','Normal Walking mean',
lgd = legend([h1, h2], 'Passive Indego', 'Controlled Indego');
set(lgd,'FontSize',10);
