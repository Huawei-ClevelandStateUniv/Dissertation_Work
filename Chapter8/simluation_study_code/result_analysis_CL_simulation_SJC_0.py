...
simulation_data_path = ('../Simulation_Study_Data/Simulation_2dData_Wmt100Wms0.005Wts1e-05Wtm1e-07Wtp0.1/'
          + gender + str(S) + '_S' + str(T) + '_N501_JC2_Phase4/')
...
# add sensor noise to the joint motion
#pink_noise = generate_pink_noise(num_joints, num_nodes)
#motion_sim[:, 2:9] = motion_sim[:, 2:9] + pink_noise

# define the optimization problem
x_c_meas_vec = motion_sim.T.flatten('F')
mom_c_meas_vec = motion_sim[:, index_open].T.flatten('F')
...
store_path = ('../Simulation_Study_Data/Simulation_Id_New/')
...
plt.plot(time_plot, motion_sim[:plot_nodes, 0], 'r-')
plt.plot(time_plot, Result[:plot_nodes, 0], 'b.', label='x translation (m)')

plt.plot(time_plot, motion_sim[:plot_nodes, 1], 'r-')
plt.plot(time_plot, Result[:plot_nodes, 1], 'g.', label='y translation (m)')

plt.plot(time_plot, motion_sim[:plot_nodes, 2], 'r-')
...
ax1.plot(time_plot, motion_sim[:plot_nodes, 3], 'r.', linewidth=2.5, label='Experimental data')
ax1.plot(time_plot, Result[:plot_nodes, 3], '-', label='Identified Trajectory')

ax2.plot(time_plot, motion_sim[:plot_nodes, 6], 'r.', linewidth=2.5, label='Experimental data')
ax2.plot(time_plot, Result[:plot_nodes, 6], '-', label='Identified Trajectory')

ax3.plot(time_plot, motion_sim[:plot_nodes, 4], 'r.', linewidth=2.5, label='Experimental data')
ax3.plot(time_plot, Result[:plot_nodes, 4], '-', label='Identified Trajectory')

ax4.plot(time_plot, motion_sim[:plot_nodes, 7], 'r.', linewidth=2.5, label='Experimental data')
ax4.plot(time_plot, Result[:plot_nodes, 7], '-', label='Identified Trajectory')

ax5.plot(time_plot, motion_sim[:plot_nodes, 5], 'r.', linewidth=2.5, label='Experimental data')
ax5.plot(time_plot, Result[:plot_nodes, 5], '-', label='Identified Trajectory')

ax6.plot(time_plot, motion_sim[:plot_nodes, 8], 'r.', linewidth=2.5, label='Experimental data')
...
ax11.plot(time_plot[1:], moment_sim[1:num_nodes, 0], 'r.', linewidth=2.5, label='Inverse Dynamics')
ax11.plot(time_plot[1:], torque_all[1:, 0], '-', label='Indentified Torques')


ax12.plot(time_plot[1:], moment_sim[1:num_nodes, 3], 'r.', linewidth=2.5, label='Inverse Dynamics')
...
ax13.plot(time_plot[1:], moment_sim[1:num_nodes, 1], 'r.', linewidth=2.5, label='Inverse Dynamics')
...
ax14.plot(time_plot[1:], moment_sim[1:num_nodes, 4], 'r.', linewidth=2.5, label='Inverse Dynamics')
...
ax15.plot(time_plot[1:], moment_sim[1:num_nodes, 2], 'r.', linewidth=2.5, label='Inverse Dynamics')
...
ax16.plot(time_plot[1:], moment_sim[1:num_nodes, 5], 'r.', linewidth=2.5, label='Inverse Dynamics')
